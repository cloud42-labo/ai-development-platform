...
| [`../governance/human-test-minimization.md`](../governance/human-test-minimization.md) | Mandatory classification/minimization rule for Human Requests and Human E2E; only irreducible Human-only checks remain manual |
